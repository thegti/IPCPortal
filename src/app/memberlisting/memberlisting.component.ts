...
@Component({
  selector: 'app-memberlisting',
  templateUrl: './memberlisting.component.html',
  styleUrls: ['./memberlisting.component.scss', '../scss/form.scss', '../scss/settingbutton.scss'],
...
//                  txtMiddleName: [''],
//                  txtLastName: [''],
//                  txtMobile: ['', [Validators.minLength(10), Validators.maxLength(10)]],
//                  ddlGender: [0],
//                  ddlTitle: [''],
//                  txtDob: [null],
...
//              this.enableHead2 = false;
//              this.isEdit = true;
//              this.url = this.GlobalUrls.API_BASE_URL + this.GlobalUrls.MemberImgFolder + this.currentMem['MMM_PHOTO'];
//             this.imgname = this.currentMem['MMM_PHOTO'];
//              this.stprPrimary = this._formBuilder.group({
//                  ddlMemberId: [this.currentMem['MMM_ID'], Validators.required],
...
//                  txtMobile: [this.currentMem['MMM_MOBIL'], [Validators.minLength(10), Validators.maxLength(10)]],
...
//           //   this.imgname = this.currentMem['MMM_PHOTO'];
//              this.stprPrimary = this._formBuilder.group({
//                  ddlMemberId: [this.currentMem['MMM_ID']],
//                  txtFirstName: [this.currentMem['MMM_NAME1'], Validators.required],
//                  txtMiddleName: [this.currentMem['MMM_NAME2']],
//                  txtLastName: [this.currentMem['MMM_NAME3']],
//                  txtMobile: [this.currentMem['MMM_MOBIL'], [Validators.minLength(10), Validators.maxLength(10)]],
...
//  onMemberSelect(): void {
//      this.getRecordReq = {
//          'REC_PK':  this.stprPrimary.value.ddlMemberId
//      };
//      this.header = { headers: { Authorization: `Bearer ${this.authService.getToken}` } };
//      this.memberService.getRecordDetails(this.getRecordReq,  this.header).subscribe((data: Array<object>) => {
//       this.currMem = data['Data'][0];
//       this.url = this.GlobalUrls.API_BASE_URL + this.GlobalUrls.MemberImgFolder + this.currMem['MMM_PHOTO'];
...
//          // 'CFG_PK':1,
//          'MMM_PK': 0,
//          'MMM_ID': this.stprPrimary.value.ddlMemberId,
...
//          'MMM_STATE': this.stprPrimary.value.txtState,
//          'MMM_MEMBER':  this.stprPrimary.value.ddlMemberId,
//          'MMM_ACTIVE': 1,
