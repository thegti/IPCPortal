...
@Component({
  selector: 'app-prnt-ministry',
  templateUrl: './prnt-ministry.component.html',
  styleUrls: ['./prnt-ministry.component.scss', '../scss/bootstrap.min.scss', '../scss/print.scss']
})
export class PrntMinistryComponent implements OnInit {
    ministrylist: any;
    pageNo = 1;
